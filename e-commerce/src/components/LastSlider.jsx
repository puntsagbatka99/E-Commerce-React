export default function LastSlider(props) {
    return (
        <div style={{display:"flex"}}>
            <div style={{ width:"650px  ",height:"369px", display: "flex", justifyContent: "space-between", alignItems: "center", border: '1px solid #C8C8C8', borderRadius: "20px", padding:"40px 17px" , margin:"0 5px"}}>
