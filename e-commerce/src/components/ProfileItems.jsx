...
export default function ProfileItems(props) {
    ...
    return (
            <div style={{ height: "242px", border: "1px solid #BABABA", borderRadius: "20px", padding: "17px", display: "flex", flexDirection: "column", justifyContent: "space-around", margin:"0 10px"}}>
